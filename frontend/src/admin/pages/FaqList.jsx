...
const FaqList = () => {
  ...
  const openDeleteModal = (faqId) => { setFaqToDelete(faqId); setShowDeleteModal(true); };
  ...
  const handleStatusConfirm = async () => {
    ...
    try {
      await axios.patch(`${API_BASE_URL}/faqs/${id}/status`, { status: newStatus });
    ...
    <>
      <div className="page-wrapper">
        <div className="page-content">
          <Breadcrumb page="Settings" title="FAQ" add_button="Add FAQ" add_link="#" onClick={() => openForm()} />
          <div className="row">
            ...
            <div className="col-md-7">
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title mb-3">Faq List</h5>
                  <DataTable
                    columns={[
