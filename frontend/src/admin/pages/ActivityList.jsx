...
const ActivityList = () => {
  ...
  const openDeleteModal = (activityId) => { setActivityToDelete(activityId); setShowDeleteModal(true); };
  ...
  const handleStatusConfirm = async () => {
    ...
    try {
      await axios.patch(`${API_BASE_URL}/activities/${id}/status`, { status: newStatus });
