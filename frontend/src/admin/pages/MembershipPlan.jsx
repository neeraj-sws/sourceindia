...
const MembershipPlan = () => {
  ...
  const openDeleteModal = (membershipPlanId) => { setMembershipPlanToDelete(membershipPlanId); setShowDeleteModal(true); };
              ...
              <DataTable
                ...
                renderRow={(row, index) => (
                  <tr key={row.id}>
                    ...
                    <td>
                      <button className="btn btn-sm btn-primary me-2 mb-2" onClick={() => openModal(row)}>
