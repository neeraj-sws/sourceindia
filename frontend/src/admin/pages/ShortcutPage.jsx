...
const ShortcutPage = () => {
  ...
  const [newRow, setNewRow] = useState({ name: "", link: "", status: 1 });
  ...
  const handleSave = async (menu) => {
    try {
      ...
      if (menu.id) {
        await axios.put(`${API_BASE_URL}/shortcut/shortcut_menus/${menu.id}`, menu);
        showNotification("Menu updated successfully", "success");
      } else {
        await axios.post(`${API_BASE_URL}/shortcut/shortcut_menus`, menu);
        showNotification("Menu added successfully", "success");
        setNewRow({ name: "", link: "", status: 1 });
      }
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`${API_BASE_URL}/shortcut/shortcut_menus/${id}`);
