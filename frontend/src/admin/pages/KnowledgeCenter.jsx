    ...
    <>
      <div className="page-wrapper">
        <div className="page-content">
          <Breadcrumb page="Settings" title="Knowledge Center" add_button="Add Knowledge Center" add_link="#" onClick={() => openForm()} />
          <div className="row">
            ...
            <div className="col-md-7">
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title mb-3">Knowledge Center List</h5>
                  <DataTable
                    columns={[
