          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                Are you sure you want to delete {isBulkDelete ? "the selected core activities" : "this core activity"}?
              </div>
        ...
        <div className="modal fade show" tabIndex="-1" style={{ display: "block" }}>
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                {
                  statusToggleInfo.field === "status" ? `Are you sure you want to ${statusToggleInfo.currentStatus === 1 ? "deactivate" : "activate"} this application status` :
                    statusToggleInfo.field === "category_status" ? `Are you sure you want to ${statusToggleInfo.currentStatus === 1 ? "deactivate" : "activate"} this  top application category status` : 
