        ...
        <div className="modal fade show" tabIndex="-1" style={{ display: "block" }}>
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">Are you sure you want to delete this {isBulkDelete ? "the selected item categories" : "this item category"}?</div>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                {statusToggleInfo.field === "delete_status"
                  ...
                  : `Are you sure you want to ${statusToggleInfo.currentStatus === 1 ? "deactivate" : "activate"} this item category?`}
              </div>
              <div className="modal-footer justify-content-between">
...
export default ItemCategoryModals;
