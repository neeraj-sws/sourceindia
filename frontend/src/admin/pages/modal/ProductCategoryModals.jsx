          ...
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">{isEditing ? "Edit Product Category" : "Add Product Category"}</h5>
              ...
              <div className="modal-body container">
                <form className="row" onSubmit={handleSubmit} noValidate>
                  ...
                  <div className="form-group col-md-6 mb-3">
                    <label htmlFor="top_category" className="form-label required">Top Category</label>
                    <select
                      id="top_category"
                  ...
                  <div className="form-group col-md-6 mb-3">
                    <label htmlFor="file" className="form-label required">Product Category Image</label>
                    <input
                      type="file"
        ...
        <div className="modal fade show" tabIndex="-1" style={{ display: "block" }}>
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">Are you sure you want to delete this Product Category?</div>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                Are you sure you want to {statusToggleInfo.currentStatus === 1 ? "deactivate" : "activate"} this Product Category?
              </div>
              <div className="modal-footer justify-content-between">
...
export default ProductCategoryModals;