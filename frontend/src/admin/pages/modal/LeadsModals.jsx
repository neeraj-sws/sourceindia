          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                Are you sure you want to delete {isBulkDelete ? "the selected leads" : "this lead"}?
              </div>
        ...
        <div className="modal fade show" tabIndex="-1" style={{ display: "block" }}>
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                {
                  statusToggleInfo.field === "account_status" ? `Are you sure you want to ${statusToggleInfo.currentStatus === 1 ? "disapprove" : "approve"} this lead` :
              ...
              <div className="modal-footer justify-content-between">
                ...
                <button type="button" className="btn btn-warning" onClick={handleStatusConfirm}>
                  {statusToggleInfo.field === "delete_status" ? statusToggleInfo.currentStatus === 1 ? "Restore" : "Remove" : "Approve"}
                </button>
              </div>
            </div>
          </div>
