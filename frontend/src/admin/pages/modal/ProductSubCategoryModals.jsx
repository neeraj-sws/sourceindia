...
const ProductSubCategoryModals = ({
  showModal,
  closeModal,
  isEditing,
  formData,
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">{isEditing ? "Edit Sub Category" : "Add Sub Category"}</h5>
      ...
      {showDeleteModal && (
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">Are you sure you want to delete this Sub Category?</div>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              Are you sure you want to {statusToggleInfo.currentStatus === 1 ? "deactivate" : "activate"} this Sub Category?
            </div>
            <div className="modal-footer justify-content-between">
...
export default ProductSubCategoryModals;