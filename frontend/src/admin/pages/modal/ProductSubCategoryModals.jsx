          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                Are you sure you want to delete {isBulkDelete ? "the selected sub categories" : "this sub category"}?
              </div>
        ...
        <div className="modal fade show" tabIndex="-1" style={{ display: "block" }}>
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                {
                  statusToggleInfo.field === "status" ? `Are you sure you want to ${statusToggleInfo.currentStatus === 1 ? "deactivate" : "activate"} this sub category Status` :
