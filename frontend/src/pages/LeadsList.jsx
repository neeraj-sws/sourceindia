            ...
            <div className="row row-cols-1 row-cols-md-2 row-cols-xl-4">
              <div className="col mb-4">
                <div className="card radius-2 overflow-hidden position-relative h-100 card-border">
                  ...
                  <img src="/element-02.svg" className="img-fluid position-absolute top-0 start-0" alt="logo icon" loading="lazy"
                    decoding="async" />
                </div>
              </div>
              <div className="col mb-4">
                <div className="card radius-2 overflow-hidden position-relative h-100 card-border">
                  ...
                  <img src="/element-04.svg" className="img-fluid position-absolute top-0 start-0" alt="logo icon" loading="lazy"
                    decoding="async" />
                </div>
              </div>
              <div className="col mb-4">
                <div className="card radius-2 overflow-hidden position-relative h-100 card-border">
                  ...
                  <img src="/element-01.svg" className="img-fluid position-absolute top-0 start-0" alt="logo icon" loading="lazy"
                    decoding="async" />
                </div>
              </div>
            </div>
