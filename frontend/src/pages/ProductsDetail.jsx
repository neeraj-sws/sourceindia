  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${API_BASE_URL}/products/company-review`,
        {
                  ...
                  <div className="row">
                    <div className="col-md-5">
                      ...
                      <Swiper
                        ...
                        style={{ maxWidth: "100%" }} // Adjust height for thumbnails
                      >
                        {allImages.map((image, index) => (
                          <SwiperSlide key={image.id || index}>
                            <ImageFront
            ...
            <div className="card mt-5">
              <div className="card-body">
                <div className="tabs-container">
                  {/* Tab Navigation */}
                  <ul
                    className="nav nav-tabs border-bottom ulnavoverflow"
                    role="tablist"
                  ...
                  <div className="tab-content mt-3">
                    ...
                    {activeTab === "productDetails" && (
                      ...
                      >
                        <div className="product-details mt-md-0 mt-3">
                          <div className="detailhead">
                            <h5 className="">Product Specification:</h5>
                          </div>
                          <div>
                            <div
                              dangerouslySetInnerHTML={{
                                __html: product.description || "N/A",
                              }}
                            />
                          </div>
                        </div>
                        ...
                        <div className="company-details">
                          ...
                          <div className="mb-3">
                            ...
                            <div className="companyInfo mt-4">
                              ...
                              <div
                                dangerouslySetInnerHTML={{
                                  __html: product.brief_company || "N/A",
                                }}
                              />
                            </div>
                          </div>
                      ...
                      <div className="productlink">
                        <div className="">
                          <div className="cateproduct">
                            <h6
                              className={
                                !similar.category_name ? "mb-0" : "mb-1"
                              }
                            >
                        ...
                        <a
                          ...
                          className="d-inline-block pt-2 btn btn-primary lh-1 text-white mt-2"
                        >
            ...
            <div className="companygrid">
              ...
              >
                {product.recommended_companies.map((company) => (
                  <SwiperSlide
                    key={company.id}
                    className=" bg-white border rounded p-2 h-100 text-center"
                  >
