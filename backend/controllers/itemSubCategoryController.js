...
exports.getItemSubCategoriesByCategorySubCategoryItemCategory = async (req, res) => {
  try {
    ...
    const itemSubCategory = await ItemSubCategory.findAll({
      where: { category_id, subcategory_id, item_category_id, status: 1, is_delete: 0 },
      include: [
        {
...
exports.getItemSubCategoriesByCategorySubCategoryItemCategoryAll = async (req, res) => {
  try {
    ...
    const itemSubCategory = await ItemSubCategory.findAll({
      where: { category_id, subcategory_id, item_category_id, is_delete: 0 },
      include: [
...
exports.getItemSubCategoryCount = async (req, res) => {
  try {
    const total = await ItemSubCategory.count({ where: { is_delete: 0 } });
    res.json({ total });
  } catch (err) {
    console.error(err);
    res.status(500).json({ error: err.message });
...
exports.updateItemSubCategoryDeleteStatus = async (req, res) => {
  try {
