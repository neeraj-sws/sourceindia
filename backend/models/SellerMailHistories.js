...
const SellerMailHistories = sequelize.define('SellerMailHistories', {
  ...
  mail_code: { type: DataTypes.STRING, allowNull: false },
  ...
  open_token: { type: DataTypes.STRING, allowNull: true, unique: true },
  is_open: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
  open_count: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
  opened_at: { type: DataTypes.DATE, allowNull: true },
  last_open_ip: { type: DataTypes.STRING, allowNull: true },
  last_user_agent: { type: DataTypes.TEXT, allowNull: true },
