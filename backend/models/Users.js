...
const Users = sequelize.define('Users', {
  ...
  remember_token: { type: DataTypes.STRING, allowNull: false },
  ...
  is_intrest: { type: DataTypes.INTEGER, allowNull: false },
  ...
  request_admin: { type: DataTypes.INTEGER, allowNull: false },
