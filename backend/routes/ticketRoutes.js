...
router.post('/', authenticateToken, ticketController.createTickets);
...
router.get('/count', authenticateToken, ticketController.getTicketsCount);
...
router.put('/:id', authenticateToken, ticketController.updateTickets);
router.delete('/:id', ticketController.deleteTickets);
router.patch('/:id/status', ticketController.updateTicketsStatus);
router.post('/:id/accept', authenticateToken, ticketController.acceptDeclineTicket);
