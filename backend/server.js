...
const categoryConflictLogsRoutes = require('./routes/categoryConflictLogsRoutes');
...
app.use(basePath + '/api/category_conflict_logs', categoryConflictLogsRoutes);
...
app.use(basePath + '/api/keywords', keywordsRoutes);
